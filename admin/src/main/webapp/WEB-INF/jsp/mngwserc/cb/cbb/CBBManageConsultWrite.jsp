        ...
        <div id="appctnPdfArea1">
            ...
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-4">
                        <input type="number" class="form-control input-sm notRequired" name="telNo"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="${rtnDto.telNo}" title="전화번호"/>
                    </div>
                </div>
            </fieldset>
            <fieldset>
            ...
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="input-group col-md-2" style="z-index:0;">
                        <input type="text" class="form-control datetimepicker_strtDt"  name="stbsmDt" value="<c:if test="${not empty rtnDto.stbsmDt}">${kl:convertDate(rtnDto.stbsmDt, 'yyyy-MM-dd', 'yyyy-MM-dd', '')}</c:if>" title="설립일자" />
