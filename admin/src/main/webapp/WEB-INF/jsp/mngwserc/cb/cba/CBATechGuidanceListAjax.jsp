            ...
            <tr data-total-count="${rtnData.totalCount}">
                <td class="text-center">
                    <label class="checkbox-inline c-checkbox">
                        <input type="checkbox" value="${list.cnstgSeq}" name="delValueList" class="checkboxSingle notRequired" data-edctn_seq="${list.cnstgSeq}" data-del-cond="${list.rsumeSttsCd}"/>
