          ...
          <div class="col-sm-5 pl0">
            <div class="col-sm-3 pr0">
              <select class="form-control input-sm" name="appctnFidCd">
                ...
                <c:forEach var="cdList" items="${cdDtlList.MNGCNSLT_APP_AREA}" varStatus="status">
...
<jsp:include page="/WEB-INF/jsp/mngwserc/cb/cbb/CBBConsultSuveyRsltLayer.jsp"></jsp:include>