            ...
            <form class="form-horizontal" id="frmData" name="frmData" method="post" >
                ...
                <fieldset>
                    <div class="form-group text-sm">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control input-sm" readonly="readonly" name="name" value="${rtnDto.name}(${rtnDto.id})" title="신청자 정보">
                        </div>
                        <div class="col-sm-1">
                            <button type="button" class="btn btn-sm btn-info btnSearch">회원검색</button>
                        </div>
                ...
                <fieldset>
                    <div class="form-group text-sm">
                        ...
                        <div class="col-sm-10 col-md-11">
                            ...
                            <div class="dropzone attachFile notRequired" data-file-field-nm="itrdcFileSeq" data-file-extn="${fileExtns}" data-max-file-size="5242880" data-max-file-cnt="1" data-title="첨부파일">
                ...
                <fieldset>
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-10 col-md-11">
                                <spring:eval var="fileExtns" expression="@environment.getProperty('app.file.fileExtns')" />
                                <spring:eval var="atchUploadMaxSize" expression="@environment.getProperty('app.file.max-size')" />
                                <div class="dropzone attachFile notRequired" data-file-field-nm="impvmFileSeq" data-file-extn="${fileExtns}" data-max-file-size="5242880" data-max-file-cnt="1" data-title="첨부파일">
                                    <div class="dz-default dz-message">
                                        <span><em class="ion-upload text-info icon-2x"></em><br />파일을 드래그&드랍 또는 선택해주세요</span>
                                    </div>
                                </div>
                                ...
                                <c:choose>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control input-sm notRequired" readonly="readonly" name="cmssrSeq" value="">
                                            </div>
                                            <div class="col-sm-1">
                                    ...
                                    <c:otherwise>
                                        ...
                                        <fieldset>
                                            <div class="form-group text-sm">
                                                <label class="col-sm-1 control-label">담당위원</label>
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control input-sm notRequired" readonly="readonly" name="cmssrSeq" value="${rsumeList.cmssrSeq}">
                                                </div>
                                                <div class="col-sm-1">
                                                    <button type="button" class="btn btn-sm btn-info btnCmtSearch">위원검색</button>
                                                </div>
...
<jsp:include page="/WEB-INF/jsp/mngwserc/cb/cba/CBAPartsMemberSrchLayer.jsp"></jsp:include>
