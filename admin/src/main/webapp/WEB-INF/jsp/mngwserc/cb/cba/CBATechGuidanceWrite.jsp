            ...
            <div id="appctnPdfArea1" >
                ...
                <fieldset>
                    <div class="form-group text-sm">
                        ...
                        <div class="col-sm-11">
                            <input type="button" class="btn btn-sm btn-gray searchPostCode" id="hqAddr" value="우편번호 검색"><br>
                            <br>
...
<%--        <div id="appctnPdfArea2">--%>
                            ...
                            <c:choose>
                                <c:when test="${not empty dlvryCmpnList}">
                                    <c:forEach var="dlvryCmpnList" items="${dlvryCmpnList}" varStatus="status">
                                        <div class="row tempRow" id="dlvryRow" style="border:solid; border-width:1px; margin-top: 10px;">
                                            ...
                                            <label class="col-sm-3 control-label">
                                                <input type="text" class="form-control input-sm dlvryRate" data-name="dlvryRateList" name="dlvryRate" value="${dlvryCmpnList.dlvryRate}" style="margin-bottom: 10px; margin-top:10px" title="매출비중" maxlength="3" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="매출비중 입력" />
                                            </label>
                                ...
                                <c:otherwise>
                                    <div class="row tempRow" id="dlvryRow" style="border:solid; border-width:1px; margin-top: 10px;">
                                        <label class="col-sm-2 control-label" style="margin-top: 15px;">업체명</label>
                                        <label class="col-sm-3 control-label">
                                            <input type="text" class="form-control input-sm dlvryCmpnNm" data-name="dlvryCmpnNmList" name="dlvryCmpnNm" value="" data-dlvryCmpnSeq="" style="margin-bottom: 10px; margin-top:10px" title="업체명" placeholder="업체명 입력"/>
                                        </label>
                                        <label class="col-sm-2 control-label" style="margin-top: 15px;">매출비중</label>
                                        <label class="col-sm-3 control-label">
                                            <input type="text" class="form-control input-sm dlvryRate" data-name="dlvryRateList" name="dlvryRate" value="" style="margin-bottom: 10px; margin-top:10px" title="매출비중" maxlength="3" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="매출비중 입력"/>
                                        </label>
                                        <label class="col-sm-1 control-label" style="margin-top: 15px;">%</label>
                            ...
                            <c:choose>
                                <c:when test="${not empty dpndCmpnList}">
                                    <c:forEach var="dpndCmpnList" items="${dpndCmpnList}" varStatus="status">
                                        <div class="row dpTempRow" id="dpndnRow" style="border:solid; border-width:1px; margin-top: 10px">
                                            <label class="col-sm-2 control-label" style="margin-top: 15px;">업체명</label>
                                            <label class="col-sm-3 control-label">
                                                <input type="text" class="form-control input-sm dpndnCmpnNm" data-name="dpndnCmpnNmList" name="dpndnCmpnNm" value="${fn:replace(dpndCmpnList.dpndnCmpnNm, ',', '')}" data-dpndnSeq="${dpndCmpnList.dpndnSeq}"style="margin-bottom: 10px; margin-top:10px" title="업체명" placeholder="업체명 입력"/>
                                            </label>
                                ...
                                <c:otherwise>
                                    <div class="row dpTempRow" id="dpndnRow" style="border:solid; border-width:1px; margin-top: 10px">
                                        <label class="col-sm-2 control-label" style="margin-top: 15px;">업체명</label>
                                        <label class="col-sm-3 control-label">
                                            <input type="text" class="form-control input-sm dpndnCmpnNm" data-name="dpndnCmpnNmList" name="dpndnCmpnNm" value="" data-dpndnSeq=""style="margin-bottom: 10px; margin-top:10px" title="업체명" placeholder="업체명 입력"/>
                                        </label>
                                        <label class="col-sm-2 control-label" style="margin-top: 15px;">의존율</label>
                                        <label class="col-sm-3 control-label">
                                            <input type="text" class="form-control input-sm dpndnRate" data-name="dpndnRateList" name="dpndnRate" value="" style="margin-bottom: 10px; margin-top:10px" title="의존율" maxlength="3" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="의존율 입력"/>
                                        </label>
                                        <label class="col-sm-1 control-label" style="margin-top: 15px;">%</label>
                                        <label class="col-sm-1 control-label closeLabel" style="display: none">
                                            <button type="button" class="close" aria-label="Close">x</button>
                ...
                <fieldset>
                    <div class="form-group text-sm appctnTypeCd">
                        ...
                        <div class="col-sm-11">
                            <label class="checkbox-inline c-checkbox">
                                <input type="checkbox" class="checkboxAll" name="appctnTypeCd" value="TEC_GUIDE_APPCTN00">
                            ...
                            <c:forEach var="appctnCdList" items="${cdDtlList.TEC_GUIDE_APPCTN}" varStatus="status">
                                ...
                                <label class="checkbox-inline c-checkbox">
                                    <input type="checkbox" class="checkboxSingle" name="appctnTypeCd" value="${appctnCdList.cd}" title="신청사항"/>
                        ...
                        <c:when test="${empty rtnDto.rsumeList}">
                            <fieldset>
                                <div class="form-group text-sm">
                                    ...
                                    <div class="col-sm-11">
                                        <select class="form-control input-sm notRequired" id="bfJdgmtRslt" name="bfreJdgmtRsltCd" title="사전심사결과" style="margin-bottom: 10px;width: 220px;">
                                            <option value="">선택</option>
                                    ...
                                    <label class="col-sm-1 control-label"></label>
                                    <div class="col-sm-8">
                                        <textarea class="form-control input-sm notRequired" id="bfreJdgmtRsltCntn" name="bfreJdgmtRsltCntn" title="사전심사결과 의견" placeholder="사전심사결과 의견 입력" maxlength="500" style="height: 150px"></textarea>
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset>
                            ...
                            <fieldset>
                                <div class="form-group text-sm">
                                    ...
                                    <div class="col-sm-11">
                                        <select class="form-control input-sm initVstRsltCd notRequired" id="initVstRsltCd" name="initVstRsltCd" title="초도방문결과" style="margin-bottom: 10px;width: 220px;">
                                            ...
                                            <c:forEach var="initVstRsltList" items="${cdDtlList.INIT_VST_RSLT}" varStatus="status">
                                                <c:if test="${initVstRsltList.cd ne 'BF_JDGMT_RSLT04'}">
                                    ...
                                    <label class="col-sm-1 control-label"></label>
                                    <div class="col-sm-8 rsltCntn" style="display: none;">
                                        <textarea class="form-control input-sm notRequired" id="initVstRsltCntn" name="initVstRsltCntn" value="" placeholder="탈락사유 입력" maxlength="500" style="height: 150px"></textarea>
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset>
                                <div class="form-group text-sm">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control input-sm notRequired" id="initVstOpnnCntn" name="initVstOpnnCntn" placeholder="초도방문의견 입력" maxlength="500" style="height: 150px"></textarea>
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset>
                                <div class="form-group text-sm">
                                    ...
                                    <div class="col-sm-3 form-inline">
                                        ...
                                        <input type="text" class="form-control input-sm notRequired" readonly="readonly" name="cmssrName" value="" style="width: 220px;">
                            ...
                            <fieldset>
                                <div class="form-group text-sm">
                                    ...
                                    <div class="col-sm-3" style="z-index:0; width: 250px;">
                            ...
                            <fieldset>
                                <div class="form-group text-sm">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control input-sm notRequired" id="xtnsnCnclRsn" name="xtnsnCnclRsn" placeholder="연기/취소 사유" maxlength="500" style="height: 150px"></textarea>
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset>
                            ...
                            <fieldset>
                                <div class="form-group text-sm">
                                    <label class="col-sm-1 control-label">랩업자료<br/>첨부파일</label>
                                    <div class="col-sm-10 col-md-11">
                                        <spring:eval var="fileExtns" expression="@environment.getProperty('app.file.fileExtns')" />
                                        <spring:eval var="atchUploadMaxSize" expression="@environment.getProperty('app.file.max-size')" />
                            ...
                            <fieldset>
                                <div class="form-group text-sm">
                                    <label class="col-sm-1 control-label">기타사업자료<br/>첨부파일</label>
                                    <div class="col-sm-10 col-md-11">
                                        <spring:eval var="fileExtns" expression="@environment.getProperty('app.file.fileExtns')" />
                                        <spring:eval var="atchUploadMaxSize" expression="@environment.getProperty('app.file.max-size')" />
                            ...
                            <c:forEach var="rsumeList" items="${rtnDto.rsumeList}" varStatus="status">
                                <fieldset>
                                    <div class="form-group text-sm">
                                        ...
                                        <label class="col-sm-1 control-label"></label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control input-sm notRequired" id="bfreJdgmtRsltCntn" name="bfreJdgmtRsltCntn" title="사전심사결과 의견" placeholder="사전심사결과 의견 입력" maxlength="500" style="height: 150px;">${rsumeList.bfreJdgmtRsltCntn}</textarea>
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
                                ...
                                <fieldset>
                                    <div class="form-group text-sm">
                                        ...
                                        <label class="col-sm-1 control-label"></label>
                                        <div class="col-sm-8 rsltCntn" style="display: none;">
                                            <textarea class="form-control input-sm notRequired" id="initVstRsltCntn" name="initVstRsltCntn" placeholder="탈락사유 입력" maxlength="500" style="height: 150px">${rsumeList.initVstRsltCntn}</textarea>
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
                                    <div class="form-group text-sm">
                                        <label class="col-sm-1 control-label">초도방문의견</label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control input-sm notRequired" id="initVstOpnnCntn" name="initVstOpnnCntn" placeholder="초도방문의견 입력" maxlength="500" style="height: 150px">${rsumeList.initVstOpnnCntn}</textarea>
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
                                ...
                                <fieldset>
                                    <div class="form-group text-sm">
                                        <label class="col-sm-1 control-label">연기/취소 사유</label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control input-sm notRequired" id="xtnsnCnclRsn" name="xtnsnCnclRsn" placeholder="연기/취소 사유" maxlength="500" style="height: 150px">${rsumeList.xtnsnCnclRsn}</textarea>
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
