...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/co/COFormCtrl controller/sm/smb/SMBMainVslListCtrl">
        ...
        <form class="form-horizontal" id="frmSearch" name="frmSearch" method="post" action="" data-del-type="board">
            ...
            <jsp:include page="/WEB-INF/jsp/mngwserc/co/COPeriodSearch.jsp">
                ...
                <jsp:param name="periodType" value="sma" />
            </jsp:include>
                        ...
                        <div class="row">
                            <div class="col-sm-3 pr0">
                                <select class="form-control input-sm" data-name="f">
                                    ...
                                    <option value="1" <c:if test="${rtnData.f eq '1'}">selected</c:if>>타이틀</option>
