...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/co/COFormCtrl controller/sm/smi/SMISmsCntnListCtrl">
        ...
        <form class="form-horizontal" name="frmSearch" method="post" action="">
            ...
            <input type="hidden" id="smsCntnSeq" name="smsCntnSeq" value="" />
            <input type="hidden" id="smsCntnCd" name="smsCntnCd" value="" />
            <!--기간 검색 시작-->
                        ...
                        <div class="row">
                            <div class="col-sm-3 pr0">
                                <select class="form-control input-sm" data-name="f">
                                    ...
                                    <option value="1" <c:if test="${rtnData.f eq '1'}">selected</c:if>>구분</option>
