...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/co/COFormCtrl controller/sm/smk/SMKTrendListCtrl">
        ...
        <form class="form-horizontal" id="frmSearch" name="frmSearch" method="post" action="" data-del-type="account">
            ...
            <input type="hidden" id="trndSeq" name="trndSeq" value="" />
            <!--기간 검색 시작-->
            ...
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-5">
                        ...
                        <label class="checkbox-inline c-checkbox">
                            <input type="checkbox" class="checkboxSingle" data-name="typeCdList" value="TYPE01" <c:if test="${fn:contains(rtnData.typeCd, 'TYPE01')}">checked</c:if> />
                            <span class="ion-checkmark-round"></span> 교육사업
                        </label>
                        <label class="checkbox-inline c-checkbox">
                            <input type="checkbox" class="checkboxSingle" data-name="typeCdList" value="TYPE02" <c:if test="${fn:contains(rtnData.typeCd, 'TYPE02')}">checked</c:if> />
                            <span class="ion-checkmark-round"></span> 컨설팅사업
                        </label>
                        <label class="checkbox-inline c-checkbox">
                            <input type="checkbox" class="checkboxSingle" data-name="typeCdList" value="TYPE03" <c:if test="${fn:contains(rtnData.typeCd, 'TYPE03')}">checked</c:if> />
                            <span class="ion-checkmark-round"></span> 상생사업
                        </label>
                    </div>
                </div>
            </fieldset>
