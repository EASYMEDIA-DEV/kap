                ...
                <table class="table table-hover table-striped" >
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" rowspan="2">교육결과</th>
                            ...
                            <th class="text-center" rowspan="2">매출액(억원)</th>
                            <th class="text-center" rowspan="2">직원수</th>
                            <th class="text-center" rowspan="2">신청 소재지</th>
                            <th class="text-center" rowspan="2">교육상태</th>
                            <th class="text-center" rowspan="2">교육 신청 인원</th>
                            <th class="text-center" rowspan="2">교육 시간</th>
                            <th class="text-center" rowspan="2">교육희망일</th>
                            <th class="text-center" rowspan="2">교육 시작일</th>
                            <th class="text-center" rowspan="2">교육 완료일</th>
                            <th class="text-center" rowspan="2">실제 참석인원</th>

                            <th class="text-center" colspan="3">신청자 정보</th>
