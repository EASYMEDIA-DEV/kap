        ...
        <form class="form-horizontal" id="frmData" name="frmData" method="post" >
            ...
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-11">
                        <p class="form-control-static">${rtnDto.prntCdNm} > ${rtnDto.ctgryCdNm}</p>
                    </div>
                </div>
            </fieldset>
            <fieldset>
            ...
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-5">
                        <p class="form-control-static">${rtnDto.stduyMthdCdNm}</p>
                    </div>

                    <label class="col-sm-1 control-label">학습시간<span class="star"> *</span></label>
                    <div class="col-sm-5">
                        <p class="form-control-static">${rtnDto.stduyDdCdNm}일/${rtnDto.stduyTimeCdNm} 시간</p>
