...
<!-- 사유 레이어 팝업(Modal) -->
<div class="modal fade ebfEduRoomSrchLayer" tabindex="-1" role="dialog" data-controller="controller/co/COFormCtrl controller/eb/ebf/EBFEduRoomListCtrl controller/wb/wbj/WBJRoundMakeCtrl">
