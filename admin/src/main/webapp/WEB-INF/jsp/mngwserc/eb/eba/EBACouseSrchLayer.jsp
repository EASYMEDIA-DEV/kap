...
<!-- 사유 레이어 팝업(Modal) -->
<div class="modal fade ebbEpisdCouseSrchLayer" tabindex="-1" role="dialog" data-controller="controller/eb/eba/EBACheckBoxCtrl controller/eb/eba/EBACouseListCtrl">
    <div class="modal-dialog modal-lg modal-center" role="document" style="width:80%;">
                ...
                <div class="modal-body">
                    ...
                    <div class="clearfix">
                        <h6 class="pull-left mt0">
                            <em class="ion-play mr-sm"></em>교육과정관리 목록 (총 <span id="listContainerTotCnt">0</span> 건)
                        </h6>
