                        ...
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-11">
                                <table class="table table-hover table-striped">
                                    ...
                                    <td class="text-center">
                                        <input type="text" class="form-control input-sm notRequired" id="picTelNo" name="picTelNo" value="${rtnDto.picTelNo}" title="담당자 전화번호" maxlength="13" placeholder="담당자 전화번호"/>
                                    </td>
                                    </tbody>
                                </table>
                            </div>
