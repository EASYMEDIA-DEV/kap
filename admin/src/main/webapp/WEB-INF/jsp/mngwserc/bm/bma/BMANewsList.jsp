...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/co/COFormCtrl controller/bm/bma/BMANewsListCtrl">
        ...
        <form class="form-horizontal" id="frmData" name="frmData" method="post" data-del-type="board">
            ...
            <jsp:include page="/WEB-INF/jsp/mngwserc/co/COPeriodSearch.jsp">
                ...
                <jsp:param name="periodType" value="bma" />
            </jsp:include>

            <fieldset>
                <div class="form-group text-sm">
                    <label class="col-sm-1 control-label">계열사</label>
                    <div class="col-sm-11">
                        ...
                        <c:choose>
                            <c:when test="${rtnData.lnggCd eq 'en'}">
                                <c:forEach var="list" items="${rtnData.codeList}">
                                    <label class="checkbox-inline c-checkbox">
                                        <input type="checkbox" class="checkboxSingle" data-name="affltCdList" value="${list.cd}" <c:if test="${fn:contains(rtnData.affltCdList, list.cd)}">checked</c:if> />
                            ...
                            <c:otherwise>
                                <c:forEach var="list" items="${rtnData.codeList}" varStatus="status">
                                    <label class="checkbox-inline c-checkbox">
                                        <input type="checkbox" class="checkboxSingle" data-name="affltCdList" value="${list.cd}" <c:if test="${fn:contains(rtnData.affltCdList, list.cd)}">checked</c:if> />
            ...
            <fieldset>
                <div class="form-group text-sm">
                    <label class="col-sm-1 control-label">메인노출여부</label>
                    <div class="col-sm-11">
                        <label class="checkbox-inline c-checkbox">
                            <input type="checkbox" class="checkboxAll" />
                            <span class="ion-checkmark-round"></span> 전체
                        ...
                        <label class="checkbox-inline c-checkbox">
                            <input type="checkbox" class="checkboxSingle" data-name="mainExpsYnList" value="Y" <c:if test="${fn:contains(rtnData.mainExpsYnList, 'Y')}">checked</c:if> />
                            <span class="ion-checkmark-round"></span> 메인노출
                        </label>
                        <label class="checkbox-inline c-checkbox">
                            <input type="checkbox" class="checkboxSingle" data-name="mainExpsYnList" value="N" <c:if test="${fn:contains(rtnData.mainExpsYnList, 'N')}">checked</c:if> />
                            <span class="ion-checkmark-round"></span> 메인미노출
                        </label>
                    </div>
                </div>
            </fieldset>
            ...
            <div class="table-responsive col-sm-12 p0 m0">
                <table class="table table-hover table-striped" >
                    ...
                    <tr>
                        ...
                        <th class="text-center">메인노출여부</th>
                        <th class="text-center">계열사</th>
