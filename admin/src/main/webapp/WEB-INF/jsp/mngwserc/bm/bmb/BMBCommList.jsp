...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/co/COFormCtrl controller/bm/bmb/BMBCommListCtrl">
        ...
        <form class="form-horizontal" id="frmData" name="frmData" method="post" data-del-type="board">
            ...
            <jsp:include page="/WEB-INF/jsp/mngwserc/co/COPeriodSearch.jsp">
                <jsp:param name="periodType" value="bmb" />
            ...
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-11">
                        ...
                        <label class="checkbox-inline c-checkbox">
                            <input type="checkbox" class="checkboxSingle" data-name="typeCdList" value="link" <c:if test="${fn:contains(rtnData.typeCdList, 'link')}">checked</c:if> />
                            <span class="ion-checkmark-round"></span> 링크
                        </label>
                        <label class="checkbox-inline c-checkbox">
                            <input type="checkbox" class="checkboxSingle" data-name="typeCdList" value="youtube" <c:if test="${fn:contains(rtnData.typeCdList, 'youtube')}">checked</c:if> />
                            <span class="ion-checkmark-round"></span> 유튜브
                        </label>
                        <label class="checkbox-inline c-checkbox">
                            <input type="checkbox" class="checkboxSingle" data-name="typeCdList" value="sns" <c:if test="${fn:contains(rtnData.typeCdList, 'sns')}">checked</c:if> />
                            <span class="ion-checkmark-round"></span> SNS
                        </label>
                    </div>
                </div>
            </fieldset>
