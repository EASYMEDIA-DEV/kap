...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/co/COFormCtrl controller/wb/wbk/WBKAFutureCarContestListCtrl">
        <h6 class="mt0"><em class="ion-play mr-sm"></em>미래차 ${pageTitle} 검색</h6>
        <form class="form-horizontal" name="frmSearch" method="post" action="">
            ...
            <div class="clearfix">
                ...
                <div class="pull-right">
                    <button type="button" class="btn btn-danger btn-sm mb-sm" id="btn_delete">삭제</button>
