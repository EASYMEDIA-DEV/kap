...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/co/COFormCtrl controller/wb/wbd/WBDASafetyListCtrl">
        <h6 class="mt0"><em class="ion-play mr-sm"></em>안전설비구축 회차 검색</h6>
        <form class="form-horizontal" name="frmSearch" method="post" action="">
            ...
            <div class="clearfix">
                <h6 class="pull-left mt0">
                    <em class="ion-play mr-sm"></em>안전설비구축 회차 목록(총 <span id="listContainerTotCnt">0</span>건)
                </h6>
            ...
            <div class="table-responsive col-sm-12 p0 m0">
                <table class="table table-hover table-striped" >
                    ...
                    <tr>
                        ...
                        <th class="text-center">최초 신청등록일시</th>
