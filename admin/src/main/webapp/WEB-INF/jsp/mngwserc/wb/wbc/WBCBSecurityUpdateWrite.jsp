...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/wb/wbc/WBCBSecurityUpdateWriteCtrl">
        ...
        <form class="form-horizontal" id="frmData" name="frmData" method="post" >
            ...
            <hr>
            <h7 class="mt0"><em class="ion-play mr-sm"></em>전체 진행상태 : ${rtnDtl[maxRsumeOrd-1].rsumeSttsNm } (${rtnDtl[maxRsumeOrd-1].mngSttsNm }) </h7>
            <br>
                            ...
                            <div class="panel-body">
                                ...
                                <fieldset>
                                    <div class="form-group text-sm">
                                        ...
                                        <div class="col-sm-5 form-inline">
                                            <input type="text" class="form-control comma notRequired" maxlength="50" id="bsnPmt" name="pbsnDtlList[0].bsnPmt" value="${rtnPbsn[0].bsnPmt}" title="사업비"<%--<c:if test="${rtnData.maxRsumeOrd ne 1}">disabled</c:if> <c:if test="${rtnDtl[0].mngSttsNm eq '미선정' || rtnDtl[0].mngSttsNm eq '선정'}">disabled</c:if>--%> /> <%-- 2024-06-04 사업비 수정 가능으로 --%>
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
                            ...
                            <div class="panel-body">
                                ...
                                <fieldset>
                                    <div class="form-group text-sm">
                                        ...
                                        <div class="col-sm-5 form-inline">
                                            <input type="text" class="form-control comma notRequired" maxlength="50" id="phswPmt" name="pbsnDtlList[1].phswPmt" value="${rtnPbsn[1].phswPmt}" title="신청자" maxlength="50" value="" <c:if test="${rtnData.maxRsumeOrd ne 2}">disabled</c:if> />
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset>
                                    <div class="form-group text-sm">
                                        <label class="col-sm-1 control-label">관리자 상태값${rtnData.maxRsumeOrd }</label>
                                        <div class="col-sm-10 form-inline">
                                            <div class="col-sm-1" style="margin-left: -15px">
                                                <c:choose>
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control rtrnRsnCntn notRequired" id="rtrnRsnCntn2" name="rsumeDtlList[1].rtrnRsnCntn" value="${rtnDtl[1].rtrnRsnCntn}" title="반려사유" placeholder="사유 입력" maxlength="50" disabled/>
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset>
                                    <div class="form-group text-sm">
                                        ...
                                        <div class="col-sm-10 col-md-11">
                                            <spring:eval var="fileExtns" expression="@environment.getProperty('app.file.fileExtns')" />
                                            <spring:eval var="atchUploadMaxSize" expression="104857600" />
                                            <div class="dropzone attachFile notRequired" data-file-field-nm="fileSeq1" data-file-extn="${fileExtns}" data-max-file-size="${atchUploadMaxSize}" data-max-file-cnt="5" data-title="사업계획서">
                                                <div class="dz-default dz-message">
                                                    <span><em class="ion-upload text-info icon-2x"></em><br />파일을 드래그&드랍 또는 선택해주세요</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3" style="margin-left: -15px">
                                                <div class="input-group">
                                                    <input type="text" class="form-control input-sm datetimepicker_strtDt notRequired" id="payDt" name="pbsnDtlList[2].payDt"
                                                           ...
                                                           title="결제/발주 일자" readonly onclick="cmmCtrl.initCalendar(this);" <c:if test="${rtnData.maxRsumeOrd ne 3}">disabled</c:if> <c:if test="${rtnDtl[2].mngSttsNm eq '미선정' || rtnDtl[2].mngSttsNm eq '선정'}">disabled</c:if>0/>
                                                    <span class="input-group-btn" style="z-index:0;">
                                                        <button type="button" class="btn btn-inverse btn-sm" onclick="cmmCtrl.initCalendar(this); jQuery(this).parent().prev().focus();">
                                                            <em class="ion-calendar"></em>
                                                        </button>
