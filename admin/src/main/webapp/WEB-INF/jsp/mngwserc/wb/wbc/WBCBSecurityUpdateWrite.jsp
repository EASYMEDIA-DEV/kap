                            ...
                            <div class="panel-body">
                                ...
                                <fieldset>
                                    <div class="form-group text-sm">
                                        ...
                                        <div class="col-sm-5 form-inline">
                                            <input type="text" class="form-control comma notRequired" maxlength="50" id="phswPmt" name="pbsnDtlList[1].phswPmt" value="${rtnPbsn[1].phswPmt}" title="신청자" maxlength="50" value="" <c:if test="${disabledChk eq 'true'}">disabled</c:if> />
                                        </div>
                                    </div>
                                </fieldset>
