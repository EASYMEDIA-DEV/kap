...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/co/COFormCtrl controller/wb/wbh/WBHACalibrationListCtrl">
        <h6 class="mt0"><em class="ion-play mr-sm"></em>검교정 신청부품사 검색</h6>
        <form class="form-horizontal" name="frmSearch" method="post" action="">
            ...
            <div class="clearfix">
                <h6 class="pull-left mt0">
                    <em class="ion-play mr-sm"></em>검교정 신청부품사 목록(총 <span id="listContainerTotCnt">0</span>건)
                </h6>
