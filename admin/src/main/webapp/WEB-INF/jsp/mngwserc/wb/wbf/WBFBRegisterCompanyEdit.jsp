                    ...
                    <fieldset>
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-5" style="margin-left: -15px">
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="nameAndId" value="${registerDtl.name}(${registerDtl.id})" title="신청자" maxlength="50" readonly/>
                                </div>
                                <div class="col-sm-1">
                ...
                <div class="container-fluid">
                                ...
                                <div class="panel-body">
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline" >
                                                <div class="input-group">
                                                    <input type="text" class="form-control input-sm datetimepicker_strtDt notRequired" name="spprtDtlList[0].accsDt" value="${spprtDtl[0].accsDt}" title="접수일" readonly="" onclick="cmmCtrl.initCalendar(this);">
                                                    <span class="input-group-btn" style="z-index:0;">
                                                    <button type="button" class="btn btn-inverse btn-sm" onclick="cmmCtrl.initCalendar(this); jQuery(this).parent().prev().focus();">
                                                        <em class="ion-calendar"></em>
                                                    </button>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static">
                                                    ${ kl:convertDate(spprtDtl[0].appctnSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <c:choose>
                                                    <c:when test="${spprtDtl[0].mngSttsCd eq 'PRO_TYPE03001_02_004'}">
                                                        <p class="form-control-static">${spprtDtl[0].mngSttsCdNm}</p>
                                                        <input type="hidden" class="notRequired"  name="spprtDtlList[0].mngSttsCd" value="${spprtDtl[0].mngSttsCd}">
                                                    </c:when>
                                                    <c:otherwise>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static">
                                                    ${ kl:convertDate(spprtDtl[0].mngSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                ...
                                <div class="panel-body">
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline" >
                                                <div class="input-group">
                                                    <input type="text" class="form-control input-sm datetimepicker_strtDt notRequired" name="spprtDtlList[1].accsDt" value="${spprtDtl[1].accsDt}" title="접수일" readonly="" onclick="cmmCtrl.initCalendar(this);">
                                                    <span class="input-group-btn" style="z-index:0;">
                                                    <button type="button" class="btn btn-inverse btn-sm" onclick="cmmCtrl.initCalendar(this); jQuery(this).parent().prev().focus();">
                                                        <em class="ion-calendar"></em>
                                                    </button>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static">
                                                    ${ kl:convertDate(spprtDtl[1].appctnSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <c:choose>
                                                    <c:when test="${spprtDtl[1].mngSttsCd eq 'PRO_TYPE03002_02_004'}">
                                                        <p class="form-control-static">${spprtDtl[1].mngSttsCdNm}</p>
                                                        <input type="hidden" class="notRequired"  name="spprtDtlList[1].mngSttsCd" value="${spprtDtl[1].mngSttsCd}">
                                                    </c:when>
                                                    <c:otherwise>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static">
                                                    ${ kl:convertDate(spprtDtl[1].mngSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                ...
                                <div class="panel-body">
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline" >
                                                <div class="input-group">
                                                    <input type="text" class="form-control input-sm datetimepicker_strtDt notRequired" name="spprtDtlList[2].accsDt" value="${spprtDtl[2].accsDt}" title="접수일" readonly="" onclick="cmmCtrl.initCalendar(this);">
                                                    <span class="input-group-btn" style="z-index:0;">
                                                    <button type="button" class="btn btn-inverse btn-sm" onclick="cmmCtrl.initCalendar(this); jQuery(this).parent().prev().focus();">
                                                        <em class="ion-calendar"></em>
                                                    </button>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static">
                                                    ${ kl:convertDate(spprtDtl[2].appctnSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <c:choose>
                                                    <c:when test="${spprtDtl[2].mngSttsCd eq 'PRO_TYPE03003_02_004'}">
                                                        <p class="form-control-static">${spprtDtl[2].mngSttsCdNm}</p>
                                                        <input type="hidden" class="notRequired"  name="spprtDtlList[2].mngSttsCd" value="${spprtDtl[2].mngSttsCd}">
                                                    </c:when>
                                                    <c:otherwise>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static" >
                                                    ${ kl:convertDate(spprtDtl[2].mngSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                    ...
                    <fieldset>
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-11">
                                <textarea class="form-control input-sm notRequired" id="admMemo" rows="10" maxlength="2000" title="관리자메모" placeholder="관리자메모를 입력하세요.">${registerDtl.admMemo}</textarea>
                                <div class="pull-right">
                                    <div class="pull-right">
                                        <p class="form-control-static">${ kl:convertDate(registerDtl.admMemoModDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}</p>
                                    </div>
                                    <div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static">
                                                    ${ kl:convertDate(rsumeTaskDtl[0].appctnSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <c:choose>
                                                    <%--<c:when test="${rsumeTaskDtl[0].mngSttsCd eq 'PRO_TYPE02001_02_004'
                                                        or rsumeTaskDtl[0].mngSttsCd eq 'PRO_TYPE02001_02_005'
                                                        or rsumeTaskDtl[0].appctnSttsCdNm eq 'PRO_TYPE02001_01_004'}">--%>
                                                    <c:when test="${rsumeTaskDtl[0].appctnSttsCdNm eq 'PRO_TYPE02001_01_004'}">
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static" >
                                                    ${ kl:convertDate(rsumeTaskDtl[0].mngSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                ...
                                <div class="panel-body">
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static" >
                                                    ${ kl:convertDate(rsumeTaskDtl[1].appctnSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                               ...
                                               <%-- <c:choose>
                                                    <c:when test="${rsumeTaskDtl[1].mngSttsCd eq 'PRO_TYPE02002_02_004'
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static">
                                                    ${ kl:convertDate(rsumeTaskDtl[1].mngSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                ...
                                <div class="panel-body">
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static">
                                                    ${ kl:convertDate(rsumeTaskDtl[2].appctnSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                ...
                                                <%--<c:choose>
                                                    <c:when test="${rsumeTaskDtl[2].mngSttsCd eq 'PRO_TYPE02003_02_002'
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static" >
                                                    ${ kl:convertDate(rsumeTaskDtl[2].mngSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                ...
                                <div class="panel-body">
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static">
                                                    ${ kl:convertDate(rsumeTaskDtl[3].appctnSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                ...
                                <div class="panel-body">
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static">
                                                    ${ kl:convertDate(rsumeTaskDtl[4].appctnSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                ...
                                <div class="panel-body">
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static">
                                                    ${ kl:convertDate(rsumeTaskDtl[5].appctnSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static" >
                                                    ${ kl:convertDate(rsumeTaskDtl[5].mngSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                                ...
                                <div class="panel-body">
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <p class="form-control-static">
                                                    ${ kl:convertDate(rsumeTaskDtl[6].appctnSttsChngDtm , 'yyyy-MM-dd HH:mm:ss', 'yyyy-MM-dd HH:mm', '')}
                                                </p>
                                            </div>
                                        </div>
                                    </fieldset>
                        ...
                        <div class="panel panel-default" data-sttsCd="PRO_TYPE02007">
                            ...
                            <div id="accEx8"class="panel-collapse collapse" role="tabpanel">
                                <div class="panel-body">
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            <label class="col-sm-2 control-label">관리자 상태값/결과7</label>
                                            <div class="col-sm-6 form-inline">
