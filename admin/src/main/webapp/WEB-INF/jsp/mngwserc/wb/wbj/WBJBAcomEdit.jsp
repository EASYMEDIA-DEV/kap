                ...
                <div id="appctnPdfArea1" >
                    ...
                    <fieldset>
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-5" style="margin-left: -15px">
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="nameAndId" value="${rtnInfo.name}(${rtnInfo.id})" title="신청자" maxlength="50" disabled/>
                                </div>
                                <div class="col-sm-1">
                    ...
                    <fieldset>
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="col-sm-4" style="margin-left: -15px">
                                    <input type="text" class="form-control " id="pstnNm" name="pstnNm" value="${rtnInfo.pstnNm}" title="직급 상세" maxlength="50"/>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset>
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-5">
                                <p class="form-control-static" id="workBsnmNo" title="재직 회사사업자번호">${rtnInfo.bsnmNo}</p>
                            </div>
                        </div>
                    </fieldset>
            ...
            <div id="appctnPdfArea2" >
                ...
                <fieldset>
                    <div class="form-group text-sm">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control input-sm same notRequired" id="rcmndName" name="rcmndName" value="${rtnInfo.rcmndName}" title="이름"  placeholder="이름 입력">
                        </div>
                ...
                <fieldset>
                    <div class="form-group text-sm">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control input-sm same notRequired" id="rcmndCmpnNm" name="rcmndCmpnNm" value="${rtnInfo.rcmndCmpnNm}" title="부품사명" placeholder="부품사명 입력">
                        </div>
                    </div>
                </fieldset>
                <fieldset>
                    <div class="form-group text-sm">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control input-sm same notRequired" id="rcmndDeptNm" name="rcmndDeptNm" value="${rtnInfo.rcmndDeptNm}" title="부서" placeholder="부서 입력">
                        </div>
                    </div>
                </fieldset>
                <fieldset>
                    <div class="form-group text-sm">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control input-sm same notRequired" id="rcmndPstnNm" name="rcmndPstnNm" value="${rtnInfo.rcmndPstnNm}" title="직급"  placeholder="직급 입력">
                        </div>
                    </div>
                </fieldset>
