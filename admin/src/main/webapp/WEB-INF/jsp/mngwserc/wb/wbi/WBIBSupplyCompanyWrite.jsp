...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/wb/wbi/WBIBSupplyCompanyWriteCtrl controller/co/COFormCtrl">
        ...
        <form class="form-horizontal" id="frmData" name="frmData" method="post" >
            ...
            <!-- 첨부파일 순번 -->
            <input type="hidden" class="notRequired" id="appctnSeq" name="appctnSeq" value="${rtnDto.appctnSeq}" />
            ...
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-5">
                        <div class="col-sm-6" style="margin-left: -15px">
                            <select class="form-control input-sm notRequired" id="sizeCd" name="sizeCd" title="규모">
                                <option value="">선택</option>
                                <c:forEach var="cdList" items="${cdDtlList.COMPANY_TYPE}" varStatus="status">
                    ...
                    <div class="col-sm-10">
                        <c:forEach var="i" begin="1" end="3" varStatus="status">
                            <div class="col-sm-12" id="sqInfoArea${status.index-1}">
                                ...
                                <select class="form-control input-sm notRequired" id="year" name="sqInfoList[${status.index-1}].year" value="" title="평가년도" style="width:auto;">
                                    <option value="">선택</option>
                                    <c:forEach var="cdList" items="${cdDtlList.CO_YEAR_CD}">
            ...
            <h6 class="mt0"><em class="ion-play mr-sm"></em>공급망안정화기금 신청정보</h6>
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-10 col-md-11">
                        ...
                        <div class="dropzone attachFile " data-file-field-nm="appctnSeq" data-file-extn="${fileExtns}" data-max-file-size="${atchUploadMaxSize}" data-max-file-cnt="1" data-title="사업신청서">
