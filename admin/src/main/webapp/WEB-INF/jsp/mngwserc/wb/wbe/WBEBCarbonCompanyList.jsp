...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/co/COFormCtrl controller/wb/wbe/WBEBCarbonCompanyListCtrl">
                ...
                <div class="form-inline text-sm">
                    ...
                    <div class="col-sm-11">
                        <div class="form-group mr-sm">
                            <select class="form-control input-sm" data-name="f" name="carbonDate">
                                <option value="1">연도 전체</option>
                                <option value="2"></option>
                            </select>
                            <select class="form-control input-sm" data-name="f" name="carbonDate">
                                <option value="1">회차 전체</option>
                                <option value="2"></option>
                            </select>
                        </div>
                    </div>
            ...
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-11">
                        ...
                        <c:forEach var="cdList" items="${classTypeList.PRO_STATE_TYPE}" varStatus="status">
                            <label class="checkbox-inline c-checkbox classType">
                        ...
                        <div class="row">
                            <div class="col-sm-3 pr0">
                                <select class="form-control input-sm" data-name="f">
                                    ...
                                    <option value="2" <c:if test="${rtnData.f eq '1'}">selected</c:if>>최초등록자</option>
                                    <option value="3" <c:if test="${rtnData.f eq '2'}">selected</c:if>>최종수정자</option>
                                </select>
                            </div>
