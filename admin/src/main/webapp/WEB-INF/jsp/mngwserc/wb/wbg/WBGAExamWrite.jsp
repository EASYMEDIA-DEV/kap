...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/wb/wbg/WBGAExamWriteCtrl controller/co/COFormCtrl">
        <form class="form-horizontal" id="frmData" name="frmData" method="post" >
            ...
            <input type="hidden" class="notRequired" name="bsnCd" value="BSN07"/>
            ...
            <div id="compnayDiv">
                            ...
                            <div class="col-sm-6">
                                <c:choose>
                                    <c:when test="${not empty userInfo.name}">
                                        <input type="text" class="form-control" id="id" value="${userInfo.name}(${userInfo.id})" title="신청자" maxlength="50" readonly/>
                                    </c:when>
                                    <c:otherwise>
                ...
                <fieldset>
                    <div class="form-group text-sm">
                        ...
                        <div class="col-sm-5">
                            <div class="col-sm-6" style="margin-left: -15px">
                                <input type="text" class="form-control telNumber" id="compTel" name="compTel" value="${userInfo.compTel}" oninput="this.value=this.value.replace(/[^0-9]/g, '')" maxlength="13" title="회사 전화번호" placeholder="회사 전화번호 입력"/>
                            </div>
                        </div>
            ...
            <c:if test="${not empty rtnData}">
                ...
                <fieldset id="admMemo">
                    <div class="form-group text-sm">
                        ...
                        <div class="col-sm-11">
                            <textarea class="form-control input-sm notRequired" id="admMemoUpd" name="admMemo" rows="10" maxlength="2000" title="관리자메모" placeholder="관리자메모를 입력하세요.">${rtnData.admMemo}</textarea>
                            <div class="pull-right">
                                <div class="pull-right">
                                        ...
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                <label class="radio-inline c-radio">
                                                    <input type="radio" class="spprtCllngYn" name="spprtCllngYn" value="Y" checked <c:if test="${rtnData.applyList[0].msEquipmentList[0].spprtCllngYn eq 'Y' || empty rtnData.applyList[0].msEquipmentList[0].spprtCllngYn}">checked</c:if> title="노출여부"/>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-6 form-inline">
                                                ...
                                                <input type="hidden" class="notRequired" id="picCmssrSeq" name="picCmssrSeq" value="${rtnData.applyList[0].msEquipmentList[0].chkCmssrSeq}">
                        ...
                        <div class="panel panel-default" id="tabIndex2">
                            ...
                            <div id="addEx2" class="panel-collapse collapse <c:if test="${rtnData.stageOrd eq 2}">in</c:if>" role="tabpanel">
                                <div class="panel-body">
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            <label class="col-sm-2 control-label">투자금액</label>
                                            <div class="col-sm-6 form-inline">
                                                <input type="text" class="form-control comma" name="nvstmPmt" value="${rtnData.applyList[1].msEquipmentList[0].nvstmPmt}" title="투자금액" maxlength="50">
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
