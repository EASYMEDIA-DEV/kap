                            ...
                            <div class="panel-body">
                                ...
                                <fieldset>
                                    <div class="form-group text-sm">
                                        ...
                                        <div class="col-sm-5 form-inline">
                                            <input type="text" class="form-control comma notRequired" maxlength="50" id="bsnPmt" name="pbsnDtlList[0].bsnPmt" value="${rtnPbsn[0].bsnPmt}" title="사업비" maxlength="50" <%--<c:if test="${rtnData.maxRsumeOrd ne 1}">disabled</c:if> <c:if test="${rtnDtl[0].mngSttsNm eq '미선정' || rtnDtl[0].mngSttsNm eq '선정'}">disabled</c:if>--%>/> <%-- 2024-06-04 사업비 수정 가능으로 --%>
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
                                            ...
                                            <div class="col-sm-1" style="margin-left: -15px">
                                                <c:choose>
                                                    ...
                                                    <c:when test="${rtnDtl[1].mngSttsNm eq '부적합'}">
                                                        <select class="form-control input-sm mngSttsCd notRequired" title="관리자 상태값" id="mngSttsCd2" name="rsumeDtlList[1].mngSttsCd"  <c:if test="${rtnData.maxRsumeOrd ne 2}">disabled</c:if> <c:if test="${rtnDtl[1].mngSttsNm eq '미선정' || rtnDtl[1].mngSttsNm eq '선정'}">disabled</c:if>>
                                                            <c:forEach var="cdList" items="${proTypeList.PRO_TYPE}" varStatus="status">
