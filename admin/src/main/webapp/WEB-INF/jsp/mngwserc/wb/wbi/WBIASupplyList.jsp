...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/co/COFormCtrl controller/wb/wbi/WBIASupplyListCtrl">
        <h6 class="mt0"><em class="ion-play mr-sm"></em>공급망안정화기금 회차 검색</h6>
        <form class="form-horizontal" name="frmSearch" method="post" action="">
            ...
            <jsp:include page="/WEB-INF/jsp/mngwserc/co/COPeriodSearch.jsp">
                ...
                <jsp:param name="srchType" value="wbia" />
            ...
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-11">
                        ...
                        <label class="checkbox-inline c-checkbox classType">
                            <input type="checkbox" class="checkboxSingle" data-name="carbonCdList" name="cd" value="STATE01"/>
                            <span class="ion-checkmark-round"></span> 접수전
                        </label>
                        <label class="checkbox-inline c-checkbox classType">
                            <input type="checkbox" class="checkboxSingle" data-name="carbonCdList" name="cd" value="STATE02"/>
                            <span class="ion-checkmark-round"></span> 접수중
                        </label>
                        <label class="checkbox-inline c-checkbox classType">
                            <input type="checkbox" class="checkboxSingle" data-name="carbonCdList" name="cd" value="STATE05"/>
                            <span class="ion-checkmark-round"></span> 접수 마감
                        </label>
                    </div>
                </div>
            </fieldset>
            ...
            <div class="clearfix">
                <h6 class="pull-left mt0">
                    <em class="ion-play mr-sm"></em>공급망안정화기금 회차 목록(총 <span id="listContainerTotCnt">0</span>건)
                </h6>
