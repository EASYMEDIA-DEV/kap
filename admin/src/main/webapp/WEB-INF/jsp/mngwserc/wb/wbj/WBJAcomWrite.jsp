        ...
        <form class="form-horizontal" id="frmData" name="frmData" method="post" >
            ...
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control telNumber notRequired" id="telNo" name="telNo" value="" title="전화번호" oninput="this.value=this.value.replace(/[^0-9]/g, '')" maxlength="13"/>
                    </div>
                </div>
            </fieldset>
            ...
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-5" style="margin-left: -15px">
                        ...
                        <div class="col-sm-4" style="margin-left: -15px">
                            <input type="text" class="form-control notRequired" style="display:none;" id="newPstnNm" name="newPstnNm" title="직급 상세" maxlength="50"/>
                        </div>
                    </div>
                </div>
            </fieldset>
