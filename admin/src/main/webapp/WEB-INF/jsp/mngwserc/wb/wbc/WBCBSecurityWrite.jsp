        ...
        <form class="form-horizontal" id="frmData" name="frmData" method="post" >
            ...
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-5">
                        <div class="col-sm-3" style="margin-left: -15px">
                            <input type="text" class="form-control telNumber notRequired" id="compTel" name="compTel" value="${rtnDto.smmryNm}" oninput="this.value=this.value.replace(/[^0-9]/g, '')" maxlength="13" title="회사 전화번호" placeholder="회사 전화번호 입력"/>
                        </div>
                    </div>
            ...
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-10 col-md-11">
                        ...
                        <div class="dropzone attachFile notRequired" data-file-field-nm="fileSeq" data-file-extn="${fileExtns}" data-max-file-size="${atchUploadMaxSize}" data-max-file-cnt="5" data-title="썸네일이미지">
                            <div class="dz-default dz-message">
                                <span><em class="ion-upload text-info icon-2x"></em><br />파일을 드래그&드랍 또는 선택해주세요</span>
                            </div>
                        </div>
                        <p class="text-bold mt">
                            ※ 파일확장자 pdf, ppt, pptx, doc, docx, xls, xlsx 파일만 등록 가능합니다. (<fmt:formatNumber value="${atchUploadMaxSize / 1024 / 1024 / 8}" maxFractionDigits="1" />MB 이하, 최대 20개 파일 등록 가능)
                        </p>
                    </div>
                </div>
            </fieldset>
