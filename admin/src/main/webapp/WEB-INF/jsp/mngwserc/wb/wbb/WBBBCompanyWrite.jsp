                ...
                <div id="compnayDiv">
                    ...
                    <fieldset>
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control telNumber notRequired" id="telNo" name="telNo" value="${userInfo.telNo}" oninput="this.value=this.value.replace(/[^0-9]/g, '')" title="전화번호" maxlength="13"/>
                            </div>
                        </div>
                    </fieldset>
                ...
                <c:if test="${not empty rtnInfo.appctnSeq}">
                    ...
                    <fieldset id="admMemo">
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-11">
                                <textarea class="form-control input-sm notRequired" id="admMemoUpd" name="admMemo" rows="10" maxlength="2000" title="관리자메모" placeholder="관리자메모를 입력하세요.">${rtnInfo.admMemo}</textarea>
