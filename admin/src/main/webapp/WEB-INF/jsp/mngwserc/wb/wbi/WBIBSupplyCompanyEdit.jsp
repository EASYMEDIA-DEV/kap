                ...
                <div id="appctnPdfArea1">
                    ...
                    <fieldset>
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="col-sm-4" style="margin-left: -15px">
                                    <input type="text" class="form-control notRequired" style="display:none;" id="pstnNm" name="pstnNm"
                    ...
                    <fieldset>
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-5">
                                <div class="col-sm-6" style="margin-left: -15px">
                                    <input type="text" class="form-control telNumber" id="compTel" name="compTel" value="${rtnInfo.compTel}" oninput="this.value=this.value.replace(/[^0-9]/g, '')" maxlength="13" title="회사 전화번호" placeholder="회사 전화번호 입력"/>
                                </div>
                            </div>
                                            ...
                                            <div class="col-sm-10 col-md-11">
                                                ...
                                                <p class="text-bold mt">
                                                    ※ ${fileExtns} 파일만 등록 가능합니다. (<fmt:formatNumber
                                                        value="${atchUploadMaxSize / 1024 / 1024}"
