                ...
                <div id="appctnPdfArea1" >
                    ...
                    <fieldset>
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-5" style="margin-left: -15px">
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="" value="${rtnInfo.name}(${rtnInfo.id})" title="신청자" maxlength="50" disabled/>
                                </div>
                                <div class="col-sm-1">
                    ...
                    <fieldset>
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="col-sm-4" style="margin-left: -15px">
                                    <input type="text" class="form-control notRequired" id="pstnNm" name="pstnNm" value="${rtnInfo.pstnNm}" title="직급 상세" maxlength="50"/>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                                ...
                                <div class="panel-body">
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-3 form-inline">
                                                <input class="form-control notRequired input-sm" type="text" id ="rtrnRsnCntn" name="rtrnRsnCntn" value="${rtnInfo.rtrnRsnCntn}" placeholder="사유입력" style="width: 100%">
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group text-sm">
                                            ...
                                            <div class="col-sm-10 col-md-11">
                                                ...
                                                <div class="dropzone attachFile notRequired" data-file-field-nm="fileSeq" data-file-extn="${fileExtns}" data-max-file-size="${atchUploadMaxSize}" data-max-file-cnt="1" data-title="신청서">
