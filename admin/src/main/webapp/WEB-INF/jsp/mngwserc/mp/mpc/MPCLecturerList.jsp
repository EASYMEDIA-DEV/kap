...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/co/COFormCtrl controller/mp/mpc/MPCLecturerListCtrl">
        ...
        <form class="form-horizontal" id="frmSearch" name="frmSearch" method="post" action="" data-del-type="account">
            ...
            <input type="hidden" id="isttrSeq" name="isttrSeq" value="" />
            <!--기간 검색 시작-->
            ...
            <div class="clearfix">
                <h6 class="pull-left mt0">
                    <em class="ion-play mr-sm"></em>${pageTitle} 목록 (총 <span id="lecturerListContainerTotCnt">0</span> 건)
                </h6>
