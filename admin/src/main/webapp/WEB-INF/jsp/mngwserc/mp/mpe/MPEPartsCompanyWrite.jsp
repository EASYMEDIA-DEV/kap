                ...
                <div class="tab-pane fade show active in" id="<c:if test="${ not empty rtnInfo }">tab1</c:if>" role="tabpanel" aria-labelledby="basicTab">
                    ...
                    <fieldset>
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control input-sm notRequired" id="cmpnNfrmlNm" name="cmpnNfrmlNm" value="${rtnDto.cmpnNfrmlNm}" title="부품사명(약식)" placeholder="부품사명(약식)을 입력해주세요." style="width: 220px;"/>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control input-sm notRequired" id="cmpnCd" name="cmpnCd" value="${rtnDto.cmpnCd}" title="부품사코드" placeholder="부품사코드를 입력해주세요." style="width: 220px;"/>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                    ...
                    <fieldset>
                        <div class="form-group text-sm form-inline">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control input-sm" id="zipcode" name="zipcode" value="${rtnDto.zipcode}" readonly placeholder="우편번호" style="width: 130px;">
                    ...
                    <fieldset>
                        <div class="form-group text-sm form-inline">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control input-sm notRequired" id="slsPmt" name="slsPmt" value="${rtnDto.slsPmt}" title="매출액" placeholder="매출액을 입력해주세요." style="width: 220px;"/> 억 원
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control input-sm notRequired" id="mpleCnt" name="mpleCnt" value="${rtnDto.mpleCnt}" title="직원수" placeholder="직원수를 입력해주세요." style="width: 220px;"/> 명
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <c:forEach var="i" begin="1" end="${ 3 - sqInfoListCnt }" varStatus="status">
                                            ...
                                            <input type="text" class="form-control input-sm notRequired" id="nm${sqInfoListCnt + 1}" name="sqInfoList${sqInfoListCnt + 1}" value="" title="SQ 업종" placeholder="SQ 업종입력" maxlength="50"/>
                                            <input type="text" class="form-control input-sm notRequired" id="score${sqInfoListCnt + 1}" name="sqInfoList${sqInfoListCnt + 1}" value="" title="점수" placeholder="SQ 점수입력" maxlength="50"/>
                                            ...
                                            <input type="text" class="form-control input-sm notRequired" id="crtfnCmpnNm${sqInfoListCnt + 1}" name="sqInfoList${sqInfoListCnt + 1}" value="" title="인증주관사명" placeholder="SQ 인증주관사 입력" maxlength="50"/>
                                            </br>
                                        </c:forEach>
                                    </c:otherwise>
                                </c:choose>
                    ...
                    <fieldset>
                        <div class="form-group text-sm">
                            ...
                            <div class="col-sm-5">
                                <textarea class="form-control input-sm notRequired" id="admMemo" name="admMemo" value="${rtnDto.admMemo}" title="관리자메모" placeholder="관리자 메모를 입력해주세요." maxlength="500"></textarea>
                            </div>
                        </div>
                    </fieldset>
