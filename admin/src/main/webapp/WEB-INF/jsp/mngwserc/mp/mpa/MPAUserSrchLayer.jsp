...
<!-- 레이어 팝업(Modal) -->
<div class="modal fade mpaUserSrchLayer" tabindex="-1" role="dialog" data-controller="controller/co/COFormCtrl controller/mp/mpa/MPAUserListCtrl">
    <div class="modal-dialog modal-lg modal-center" role="document" style="width:1000px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" >▣ 일반회원 검색
            ...
            <form>
                ...
                <div class="modal-body">
                    ...
                    <div class="clearfix">
                        <h6 class="pull-left mt0">
                            <em class="ion-play mr-sm"></em>일반회원 목록 (총 <span id="partsComListContainerTotCnt">0</span> 건)
                        </h6>
                ...
                <div class="modal-footer row">
                    <div class="text-center">
                        <button type="button" class="btn btn-success down mt btnUserLayerChoice">선택</button>
                    </div>
                </div>
                <!--리스트 종료 -->
            </form>
