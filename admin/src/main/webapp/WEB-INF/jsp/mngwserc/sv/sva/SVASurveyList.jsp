...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/co/COFormCtrl controller/sv/sva/SVASurveyListCtrl">
        ...
        <form class="form-horizontal" id="frmSearch" name="frmSearch" method="post" action="">
            ...
            <fieldset>
                <div class="form-group text-sm">
                    <label class="col-sm-1 control-label">설문유형</label>
                    <div class="col-sm-5">
                        <label class="checkbox-inline c-checkbox">
                            <input type="checkbox" class="checkboxAll" />
                            <span class="ion-checkmark-round"></span> 전체
                        </label>
                        <c:forEach var="cdList" items="${cdDtlList.SURVEY_TYPE}" varStatus="status">
                            <label class="checkbox-inline c-checkbox">
                                <input type="checkbox" class="checkboxSingle" data-name="typeCdList" value="${cdList.cd}"  <c:if test="${fn:contains(rtnData.typeCdList, cdList.cd)}">checked</c:if>/>
