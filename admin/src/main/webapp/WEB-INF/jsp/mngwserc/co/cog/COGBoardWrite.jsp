        ...
        <form class="form-horizontal" id="frmData" name="frmData" method="post" >
            ...
            <fieldset>
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-11">
                        <textarea class="form-control notRequired ckeditorRequired" id="cnts" name="cnts" title="내용" data-type="${pageGb}">${info.cnts}</textarea>
                    </div>
                </div>
            </fieldset>
            <fieldset class="last-child mb0">
                <div class="form-group text-sm">
                    ...
                    <div class="col-sm-10 col-md-11">
                        <textarea class="form-control notRequired" id="jsCnts" name="jsCnts" title="자바스크립트" rows="10">${info.jsCnts}</textarea>
                    </div>
                </div>
            </fieldset>
            <fieldset>
