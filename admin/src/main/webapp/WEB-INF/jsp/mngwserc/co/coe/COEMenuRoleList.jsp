...
<div class="container-fluid">
    <div class="card-body" data-controller="controller/co/COFormCtrl controller/co/coe/COEMenuRoleLogCtrl">
        ...
        <form class="form-horizontal" name="frmSearch" method="post" action="">
            ...
            <input type="hidden" id="bfreDetailsKey" name="bfreModSeq" value="" />
            <!--기간 검색 시작-->
