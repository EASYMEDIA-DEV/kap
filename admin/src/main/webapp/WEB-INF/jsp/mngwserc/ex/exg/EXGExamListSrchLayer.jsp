			...
			<div class="modal-body">
							...
							<div class="col-sm-4">
								<div class="row">
									...
									<div class="col-sm-9 pr0">
										<input type="text" class="form-control input-sm" id="q" data-name="q" value="" maxlength="50" />
									</div>
								</div>
							</div>
				...
				<div class="modal-footer row">
					<div class="text-center">
						<button type="button" class="btn btn-success down mt btnExamSrchLayerChoice">선택</button>
					</div>
				</div>
				<!--리스트 종료 -->
			</form>
