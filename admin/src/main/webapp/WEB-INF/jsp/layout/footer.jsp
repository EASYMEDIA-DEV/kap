             				...
             				<div class="pull-left wd-tiny mb">
               					<div class="setting-color">
                 					<label class="preview-theme-1">
                   						<input type="radio" name="setting-theme" value="0" checked="checked" />
			            ...
			            <c:set var="sidebarOffcanvas" value="${kl:decode(cookie.sidebarOffcanvas.value, '', '', cookie.sidebarOffcanvas.value)}" />
			           	<p>
			              	<label class="mda-checkbox">
			                	<input id="sidebar-showheader" type="checkbox" ${sidebarShowheader}>
			                	<em class="bg-indigo-500"></em>Sidebar header
			              	</label>
			            </p>
			            <p>
			              	<label class="mda-checkbox">
			                	<input id="sidebar-showtoolbar" type="checkbox" ${sidebarShowtoolbar}>
			                	<em class="bg-indigo-500"></em>Sidebar toolbar
			              	</label>
			            </p>
            			<p>
              				<label class="mda-checkbox">
                				<input id="sidebar-offcanvas" type="checkbox" ${sidebarOffcanvas}>
