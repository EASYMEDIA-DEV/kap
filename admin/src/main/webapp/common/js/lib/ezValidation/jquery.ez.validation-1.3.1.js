...
(function($){	
	...
	$.fn.validation = function(options){
		...
		msg.confirm = settings.msg.confirm.def;
		...
		*/
		...
		$this.submit(function(e){
			...
			if (isOk)
			{
				...
				// action-type에 따른 기본 메시지 설정
				if(typeof $this.data().actionType != "undefined"){
					msg.confirm = eval("validation.defaults.msg.confirm." + $this.data().actionType);
				}
