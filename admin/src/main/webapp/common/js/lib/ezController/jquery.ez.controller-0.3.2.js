/*
 * version 0.3.2
 * 2018.12.07 : 해당 컨트롤러 객체에 모델의 id가 속해 있지 않을 경우 툴팁으로 알림 추가
 */
define([], function() {
	...
	feel.controller = function(controllerName, mode){
		...
		this.exec = function(){
			...
			$('.notModel').each(function(index, obj){
				...
				$(obj).data('placement','right').attr('title','This object was not included ' + controllerName[controllerName.length - 1]  + ' area').tooltip();
			});
		};
