            ...
            btnUpdAdmMemo : {
                event : {
                    click : function() {
                        ...
                        if(appctnSeq != '') {
                            let wBBACompanySearchDto = {}
                            wBBACompanySearchDto.admMemo = $('#admMemoUpd').val();
                            wBBACompanySearchDto.appctnSeq = appctnSeq
                            ...
                            }, "./updAdmMemo", wBBACompanySearchDto, "text")
                        }
                    }
                }
            },
                ...
                event: {
                    click: function () {
                        ...
                        cmmCtrl.getPartsCompanyMemberLayerPop(function (data) {
                            ...
                            }, "/mngwserc/" + wbUrl1 + "/" + wbUrl2 + "/" + bsnCd + "/selModalDetail", $formObj, "post", "json");
                        });
                    }
                }
            },
