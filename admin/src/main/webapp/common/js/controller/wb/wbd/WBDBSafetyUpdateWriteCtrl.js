define(["ezCtrl", "ezVald", "CodeMirror", "CodeMirror.modeJs"], function(ezCtrl, ezVald, CodeMirror) {
    ...
    // set controller name
    var exports = {
        controller : "controller/wb/wbd/WBDBSafetyUpdateWriteCtrl"
    };
            ...
            btnUpdAdmMemo : {
                event : {
                    click : function() {
                        ...
                        if(appctnSeq != '') {
                            let wBDBSafetySearchDTO = {}
                            wBDBSafetySearchDTO.admMemo = $('#admMemo').val();
                            wBDBSafetySearchDTO.appctnSeq = appctnSeq
                            ...
                            }, "/mngwserc/wb/wbdb/updAdmMemo", wBDBSafetySearchDTO, "text")
                        }
                    }
                }
            },
        ...
        immediately : function() {
            ...
            $formObj.validation({
                after : function() {
                    ...
                    if(sbrdnBsnmNo != null && sbrdnBsnmNo != '' && sbrdnBsnmNo != sbrdnBsnmNoBef){
                        jQuery.ajax({
