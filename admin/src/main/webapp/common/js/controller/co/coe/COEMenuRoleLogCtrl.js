define(["ezCtrl"], function(ezCtrl) {
    ...
    // set controller name
    var exports = {
        controller : "controller/co/coe/COEMenuRoleLogCtrl"
    };
    ...
    var search = function (page){
        ...
        }, "/mngwserc/co/coe/select", $formObj, "POST", "html");
            ...
            listView : {
                event : {
                    click : function() {
                        ...
                        var bfreModSeq = $(this).data("bfreDetailsKey");
                        $formObj.find("input[name=detailsKey]").val(detailsKey);
                        $formObj.find("input[name=bfreModSeq]").val(bfreModSeq);
