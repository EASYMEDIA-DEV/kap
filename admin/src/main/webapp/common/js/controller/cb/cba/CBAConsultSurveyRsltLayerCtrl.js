define(["ezCtrl"], function(ezCtrl) {
    ...
    // set controller name
    var exports = {
        controller : "controller/cb/cba/CBAConsultSurveyRsltLayerCtrl"
    };
    ...
    var search = function(page){
        ...
        }, "./selectSurveyRslt", $formObj, "GET", "html");
    }
                ...
                event: {
                    click: function () {
                        ...
                        if (rsn != "") {
                            ...
                            //파라미터를 물고 가야함.
                            location.href = "/mngwserc/cb/cba/srvRsltExcel-down?" + frmDataObj.serialize();
