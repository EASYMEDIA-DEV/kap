 ...
 * </pre>
 *
 * @ClassName		    : COFileController.java
...
public class COFileController {
     ...
     * @Description		: 첨부파일 업로드 Controller
     * @author 박주석
     * @since 2022.03.24
     * @version 1.0
     * @see
    ...
    public class COFileRestController {
       ...
       */
            ...
            try
            {
                ...
                if(request.getContentType() != null && request.getContentType().indexOf("multipart") > -1){
                    ...
                    while (itr.hasNext())
                    {
                        ...
                        System.out.println("file.getName()1 : " + file.getName());
                        System.out.println("file.getSize()2 : " + file.getSize());
                    }
                    if (!files.isEmpty())
                    {
         ...
         * 파일 정보 조회한다.
         */
        @RequestMapping(value="/mngwserc/file/list")
