...
@RequestMapping(value="/mngwserc/{langCd}/eb/ebf")
public class EBFEduRoomController {
    ...
    public String getMnPopListPage(SMCMnPopDTO SMCMnPopDTO, ModelMap modelMap, HttpServletRequest request, @PathVariable String langCd, @PathVariable("gubun") String gubun) throws Exception
    {
