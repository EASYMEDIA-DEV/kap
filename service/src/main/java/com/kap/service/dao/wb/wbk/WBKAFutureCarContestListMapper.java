...
public interface WBKAFutureCarContestListMapper {
    /**
     * 회차 조회
     */
    public List<WBFutureCarContestSearchDTO> selectFutureCarContestList(WBFutureCarContestSearchDTO wBFutureCarContestSearchDTO);
