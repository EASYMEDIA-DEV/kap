	...
	var config = {
		confirm : {
			...
			eb : {
				ebi : {
					auth : {
						cf_001 : '교육 신청을 취소하시겠습니까?'
					},
					step : {
						cf_001 : '교육 취소 시 입력된 정보는 저장되지 않습니다.\n교육 신청을 취소하시겠습니까?'
					}
				}
			}
		},
		...
		fail : {
			...
			eb : {
				...
				ebi : {
					auth : {
						al_001 : '신청내역이 존재하지 않습니다.' ,
						al_002 : '성명을 입력해주세요.' ,
						al_003 : '휴대폰번호를 입력해주세요.' ,
						al_004 : '이메일 주소를 입력해주세요.',
						al_005 : '교육 신청이 취소되었습니다.'
					},
					step : {
						al_001 : '사업자등록번호를 입력해주세요.' ,
						al_002 : '올바르지 않은 사업자등록번호입니다.\n‘123-45-67890’(- 제외) 형식으로 입력해주세요.' ,
						al_003 : '사업자등록번호를 인증해주세요.' ,
						al_004 : '성명을 입력해주세요.',
						al_005 : '부서를 입력해주세요.',
						al_006 : '직급을 입력해주세요.',
						al_007 : '휴대폰번호를 입력해주세요.',
						al_008 : '이메일 주소를 입력해주세요.',
						al_009 : '개인정보 사용 동의 약관에 동의해주세요.',
						al_010 : '교육 가능한 인원이 초과되었습니다.',
						al_011 : '교육 정보가 변경되었습니다. 다시 신청 바랍니다.',
						al_012 : '이미 등록된 신청자 입니다.',
					}
				}
			},
			mp : {
