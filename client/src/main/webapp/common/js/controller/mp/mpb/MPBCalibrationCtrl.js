define(["ezCtrl", "ezVald","ezFile"], function(ezCtrl, ezVald) {
    ...
    // set controller name
    var exports = {
        controller : "controller/mp/mpb/MPBCalibrationCtrl"
    };
                ...
                event : {
                    click : function() {
                        ...
                        if (equipLength > 100) {
                            ...
                            $('.equiment').last().find(".tchlgNm").attr("name","equiment.euipmentList["+ equipLength +"].tchlgNm");
                            $('.equiment').last().find(".tchlgCnt").attr("name","equiment.euipmentList["+ equipLength +"].tchlgCnt");
                            equidChagneFunction();
                        }
                    }
                }
                ...
                event : {
                    click : function() {
                        ...
                        $('.equiment').each(function(index) {
                            $(this).find(".tchlgNm").attr("name","equiment.euipmentList["+ index +"].tchlgNm");
                            $(this).find(".tchlgCnt").attr("name","equiment.euipmentList["+ index +"].tchlgCnt");
                        });
