...
<div class="cont-wrap" data-controller="controller/im/ima/IMAQaWriteCtrl">
        ...
        <div class="right-con-area">
                                            ...
                                            <div class="data-line">
                                                <div class="form-group">
                                                    <div class="form-select">
                                                        <select class="form-control input-sm" data-name="inqFir" id="inqFir" name="inqFir">
                                                    ...
                                                    <div class="form-select">
                                                        <select class="form-control input-sm" data-name="inqSec" id="inqSec" name="inqSec">
                                                            <option value="">선택</option>
                                                            <c:forEach var="cdList" items="${cdDtlList.INQUIRY_TYPE}" varStatus="status">
                                            ...
                                            <div class="data-line">
                                                <div class="form-group">
                                                    <div class="form-textarea">
                                                        <textarea name="" id="" cols="" rows="" placeholder="내용입력"></textarea>
            ...
            <div class="page-bot-btn-sec scroll-motion">
                <div class="btn-wrap for-motion">
                    ...
                    <div class="btn-set">
                        <a class="btn-solid small black-bg" href="javascript:"><span>문의등록</span></a>
                    </div>
                </div>
            </div>
        </div>
