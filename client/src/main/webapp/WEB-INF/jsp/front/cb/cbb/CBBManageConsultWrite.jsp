                                            ...
                                            <div class="data-inner-line tempRow" id="dlvryRow">
                                                <div class="form-group">
                                                    <div class="form-input w-longer">
                                                        <input type="text" name="dlvryCmpnNm" placeholder="업체명 입력">
                                                    </div>
                                                    <div class="form-input">
                                                        <input type="text" name="dlvryRate" placeholder="매출비중(%) 입력">
                                                    </div>
                                    ...
                                    <div class="td">
                                        <div class="data-line-w" id="dpTempDiv">
                                            <div class="data-inner-line dpTempRow" id="dpndnRow">
                                                <div class="form-group">
                                                    <div class="form-input w-longer">
                                                        <input type="text" placeholder="업체명 입력" name="dpndnCmpnNm">
                                                    </div>
                                                    <div class="form-input">
                                                        <input type="text" placeholder=" 의존율(%) 입력" name="dpndnRate">
                                                    </div>
                                                    <!-- 업체 추가 버튼은 마지막 추가된 리스트에 표시됩니다 -->
                                                    <div class="btn-wrap">
                                                        <button class="btn-text-icon delete closeLabel" type="button" style="display: none"><span>삭제</span></button>
                                    ...
                                    <div class="td">
                                        <div class="data-line-w">
                                            <div class="data-line">
                                                <div class="form-group">
                                                    <div class="form-input">
                                                        <input type="number" name="qltyPicCnt" placeholder="인원수 입력">
                                    ...
                                    <div class="td">
                                        <div class="data-line-w">
                                            <div class="data-line">
                                                <div class="form-group">
                                                    <div class="form-input">
                                                        <input type="text" class="notRequired" name="faxNo" placeholder="FAX 입력">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="data-line">
                                                <div class="opt-group">
                                                    <div class="form-radio">
                                                        <input type="radio" id="radio1" name="rprsntApprvYn">
                                                        <label for="radio1">승인</label>
                                                    </div>
                                                    <div class="form-radio">
                                                        <input type="radio" id="radio2" name="rprsntApprvYn">
