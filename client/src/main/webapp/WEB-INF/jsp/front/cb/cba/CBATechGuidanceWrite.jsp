                                                    ...
                                                    <div class="inner-line">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="btn-wrap btn-down-wrap">
                                                                <a class="btn-text-icon download fileDown" href="javascript:" data-url="/file/download?fileSeq=${fileData.tchgdFileSeq}&fileOrd=${fileData.tchgdFileOrd}" download><span>양식 다운로드</span></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
