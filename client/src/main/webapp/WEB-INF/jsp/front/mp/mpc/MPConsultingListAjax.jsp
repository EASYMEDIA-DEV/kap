                            ...
                            <div class="txt-area">
                                ...
                                <div class="top-line">
                                    <div class="sort-label-area">
                                        ...
                                        <%--<p class="training-name f-title3 dtlBtn" data-seq="${appctnList.cnstgSeq}">${appctnList.bsnYear} 기술지도 </p>--%>
                                    <p class="training-name f-title3"><a class="dtlBtn" href="javascript:" data-seq="${appctnList.cnstgSeq}" data-trnsf-yn="${appctnList.trnsfYn}">${appctnList.bsnYear} 기술지도 </a></p><!-- 2024-01-19 a태그 추가 -->
                                </div>
                                <div class="group">
                                    <c:choose>
                        ...
                        <div class="txt-area open">
                            <div class="top-line">
                                <div class="sort-label-area">
                                    ...
                                    <%--<p class="training-name f-title3 dtlBtn" data-seq="${appctnList.cnstgSeq}">${appctnList.bsnYear} 경영컨설팅 </p>--%>
                                <p class="training-name f-title3"><a class="dtlBtn" href="javascript:" data-seq="${appctnList.cnstgSeq}" data-trnsf-yn="${appctnList.trnsfYn}">${appctnList.bsnYear} 경영컨설팅 </a></p><!-- 2024-01-19 a태그 추가 -->
                            </div>
                            <div class="group">
                                <c:choose>
