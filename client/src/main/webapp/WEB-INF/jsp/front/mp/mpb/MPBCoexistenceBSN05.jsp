                ...
                <div class="article-list-w accordion-st"><!-- accordion-st : 아코디언 스타일 -->
                                            ...
                                            <div class="data-line">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-input w-longer">
                                                        <input type="text" id="sbrdnBsnmNo" name="wBEBCarbonCompanyMstInsertDTO.sbrdnBsnmNo" placeholder="종된사업장번호 입력" value="${rtnData.sbrdnBsnmNo}" maxlength="4" ${readonly1}>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="data-line">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-input w-longest">
                                                            <input type="text" id="dtlAddr" name="wBEBCarbonCompanyMstInsertDTO.pbsnDtlList[0].pbsnDtlAddr" placeholder="상세주소 입력" value="${rtnPbsn[0].pbsnDtlAddr}" maxlength="100" ${readonly1}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="list-item <c:if test="${rtnData.maxRsumeOrd eq 6}">active</c:if>"><!-- 활성화된 단계 active 클래스 추가 (아코디언 열림) -->
                        <form name="frmData4" id="frmData6">
                            ...
                            <input type="hidden" id="mngSttsCd6" name="wBEBCarbonCompanyMstInsertDTO.rsumeDtlList[0].mngSttsCd" value="${rtnDtl[5].mngSttsCd}">
                            <input type="hidden" id="appctnSttsCd6" name="wBEBCarbonCompanyMstInsertDTO.rsumeDtlList[0].appctnSttsCd" value="${rtnDtl[5].appctnSttsCd}">
