                                ...
                                <div class="for-flex">
                                    <div class="for-center">
                                                            ...
                                                            <div class="data-line">
                                                                <div class="opt-group total-check-w">
                                                                    ...
                                                                    <div class="form-checkbox">
                                                                        <input type="checkbox" id="businessChk2" name="businessChk" value="CONSULT_GB01" checked>
                                                                        <label for="businessChk2">기술지도</label>
                                                                    </div>
                                                                    <div class="form-checkbox">
                                                                        <input type="checkbox" id="businessChk3" name="businessChk" value="CONSULT_GB02" checked>
                                                        ...
                                                        <div class="data-line-w">
                                                            <div class="data-line">
                                                                <div class="form-input srch-input w-longer">
                                                                    <input type="text" name="f" placeholder="사업명 입력">
                                        ...
                                        <div class="btn-wrap">
                                            ...
                                            <div class="btn-set">
                                                <button class="btn-solid small gray-bg" id="btnRefresh"><span>필터 초기화</span></button>
