                                                        ...
                                                        <c:forEach var="item" items="${rtnData.euipmentList}" varStatus="status">
                                                            ...
                                                            <div class="form-group equiment">
                                                                <div class="form-input w-longer">
                                                                    <input type="text" class="tchlgNm" name="equiment.euipmentList[${status.index}].tchlgNm" value="${item.tchlgNm}" placeholder="장비명 입력" maxlength="50" ${readonly1}>
                                                                </div>
                                                                <div class="amount-div">
                                                                    ...
                                                                    <div class="form-input">
                                                                        <input type="text" class="tchlgCnt numberChk" name="equiment.euipmentList[${status.index}].tchlgCnt" value="${item.tchlgCnt}" title="대상장비 수량" ${readonly1}>
                                                                    </div>
                                        ...
                                        <div class="td">
                                            <div class="data-line-w">
                                                <div class="data-line">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-input w-longer">
                                                            <input type="text" class="comma" name="equiment.wbhaMsEuipmentDTO.clbtnExpnsPmt" placeholder="투자금액 입력" value="${rtnData.applyList[1].msEquipmentList[0].clbtnExpnsPmt}" ${readonly2}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
