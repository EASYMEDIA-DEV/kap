                                        ...
                                        <c:choose>
                                                ...
                                                <div class="opt-group verticality"><!-- verticality : 아래로 떨어지는 -->
                                                    <c:forEach var="exmplList" items="${qstnList.svSurveyExmplDtlList}" varStatus="exmplStatus">
                                                        <div class="form-radio exmplList">
                                                            <input type="radio" class="${notRequired} answer" id="answerOption${qstnList.qstnOrd}-${exmplList.exmplOrd}" name="answer${qstnList.qstnSeq}" value="${exmplList.exmplSeq}" title="${titleVal}" data-next-no ="${exmplList.nextNo}">
                                                ...
                                                <div class="opt-group verticality"><!-- verticality : 아래로 떨어지는 -->
                                                    <c:forEach var="exmplList" items="${qstnList.svSurveyExmplDtlList}" varStatus="exmplStatus">
                                                        <div class="form-checkbox exmplList">
                                                            <input type="checkbox" class="${notRequired} answer" id="answerOption${qstnList.qstnOrd}-${exmplList.exmplOrd}" name="answer${qstnList.qstnSeq}" value="${exmplList.exmplSeq}" title="${titleVal}" data-next-no ="${exmplList.nextNo}">
                                                            <label for="answerOption${qstnList.qstnOrd}-${exmplList.exmplOrd}">${exmplList.exmplNm}</label>
                                                        </div>
                                                    </c:forEach>
                                                </div>
                                            ...
                                            <c:when test="${qstnList.srvTypeCd eq 'QST03'}">    <!--주관식단답-->
                                                <div class="form-input w-full exmplList">
                                                    <input type="text" placeholder="답변을 작성해주세요." class="${notRequired} answer" name="answer${qstnList.qstnSeq}" title="${titleVal}">
                                                </div>
                                            </c:when>
                                            ...
                                            <c:when test="${qstnList.srvTypeCd eq 'QST05' || qstnList.srvTypeCd eq 'QST06' || qstnList.srvTypeCd eq 'QST07'}">    <!--척도-->
                                                <div class="criterion-form">
                                                    <div class="criterion-list-w">
                                                        <c:forEach var="exmplList" items="${qstnList.svSurveyExmplDtlList}" varStatus="exmplStatus">
                                                            <div class="form-radio exmplList">
                                                                <input type="radio" id="criterionOption${qstnList.qstnOrd}-${exmplList.exmplOrd}" class="${notRequired} answer" name="answer${qstnList.qstnSeq}" value="${exmplList.exmplSeq}" title="${titleVal}" data-next-no ="${exmplList.nextNo}">
