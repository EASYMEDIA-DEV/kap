                            ...
                            <div class="for-motion">
                                ...
                                <div class="sec-con-area">
                                    <div class="gray-bg-sec">
                                        <div class="flex">
                                            <p class="f-title1">2023 <br class="only-mobile"/>${rtnData.cnstgNm}</p>
                                            <div class="group">
                                                <p class="f-head">지도단계</p>
                                                <div class="status-info-w">
                                                    <p class="box-label bigger accepting"><span>지도중</span></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="def-list-w">
                                            <div class="def-list">
                                                ...
                                                <p class="txt f-sub-head">2023-01-01</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="sec-con-area">
                                    <div class="graphic-sec">
                                        <div class="box-btn-area">
                                            ...
                                            <div class="btn-wrap">
                                                <a class="btn-solid small white-bg" href="javascript:"><span>참여하기</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
