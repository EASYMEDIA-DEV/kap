                        ...
                        <div class="form-group">
                          ...
                          <div class="btn-wrap btn-down-wrap">
                            <c:forEach var="item" items="${rtnRoundDtl.smjList}" varStatus="status">
                              <a class="btn-text-icon download fileDown" href="javascript:" data-url="/file/download?fileSeq=${item.sftyFcltyFileSeq}&fileOrd=${item.fileOrd}" download="" title="양식 다운로드"><span>양식 다운로드</span></a>
                      ...
                      <div class="agree-box">
                        <div class="gray-bg-sec narrow-pad">
                          <div class="paragraphs">
                            ...
                            <p class="txt f-body2">
                              1. 개인정보의 수집·이용 목적
                              <br/>부품사를 대상으로 하는 부품사 안전설비 구축 지원과 관련한 안내 및 기타 정보 제공
                            </p>
                            <p class="txt f-body2">
                              2. 수집하는 개인정보 항목
                              <br/>부품사 안전설비 구축 지원 사업을 신청하는 부품사의 부품사 주소, 담당자 성명, 소속회사, 전화번호, 이메일주소
                            </p>
                            <p class="txt f-body2">
                              3. 개인정보 보유 및 이용기간
                              <br/>개인정보 수집·이용 동의시점으로부터 안전설비 구축 지원 사업 종료시점까지(단, 동의 철회 시 즉시 파기)
                            </p>
                            <p class="txt f-body2">
                              4. 동의를 거부할 권리 및 동의 거부시 불이익 사항
                              <br/>귀하는 개인정보 수집·이동 동의를 거부할 권리가 있으며 동의 거부시에는 안전설비 구축 지원에 제한이 있을 수 있습니다.
                            </p>
                          </div>
                          <div class="paragraphs">
                            ...
                            <p class="txt f-body2">
                              1. 개인정보를 제공받는자
                              <br/>자동차부품산업진흥재단, 안전장비 공급사, 안전장비 설치사, 기부금 출연사
                            </p>
                            <p class="txt f-body2">
                              2. 개인정보를 제공받는 자의 개인정보 이용 목적
                              <br/>부품사 지원공고문 발송, 안전장비 가이드 안내, 현장 점검, 안전장비 설치 등 지원사업을 위한 제반 업무
                            </p>
                            <p class="txt f-body2">
                              3. 제공하는 개인정보 항목
                              <br/>부품사 안전설비 구축 지원 사업을 신청하는 부품사의 부품사 주소, 담당자 성명, 소속회사, 휴대전화번호(연락처), 이메일주소
                            </p>
                            <p class="txt f-body2">
