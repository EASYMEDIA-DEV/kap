...
<div class="cont-wrap" data-controller="controller/wb/wbi/WBISupplyCtrl">
    <!--
                        ...
                        <div class="sec-con-area">
                            <div class="graphic-sec">
                                <div class="box-btn-area">
                                    ...
                                    <div class="btn-wrap">
                                        <a class="btn-solid small white-bg" href="/foundation/cs/qa/index?inqFir=INQ07&inqSec=공급망안정화기금"><span>신청 문의하기</span></a>
                                    </div>
                                </div>
                ...
                <div class="accepting-fixed-area">
                    <div class="for-position">
                        <button class="open-click-area" type="button">
                            <p class="tit"><span>${rtnRoundDtl.year} ${rtnRoundDtl.episd}차 공급망안정화기금 사업 접수중</span></p>
                        ...
                        <div class="hide-area">
                            <div class="inner-con">
                                <div class="tit-area">
                                    <p class="f-title1">${rtnRoundDtl.year} ${rtnRoundDtl.episd}차 공급망안정화기금 사업 접수중</p>
                                </div>
                                <div class="con-area">
                                    <div class="scroll-area">
                                        <div class="info-line-list-w">
                                            <div class="list">
                                                <p class="tit">접수기간</p>
                                                <p class="txt">
                                                    ${kl:convertDate(rtnRoundDtl.accsStrtDtm, 'yyyy-MM-dd HH:mm:ss', 'yyyy.MM.dd HH:mm', '-')}
                                                    ~
                                ...
                                <div class="btn-wrap">
                                    <div class="btn-set">
                                        <c:forEach var="item" items="${rtnRoundDtl.optnList}" varStatus="status">
                                            <a class="btn-solid small gray-bg has-icon download" href="/file/download?fileSeq=${item.fileSeq}&fileOrd=${item.optnOrd}" download="" title="양식 다운로드"><span>양식 다운로드</span></a>
                                        </c:forEach>
                                    </div>
                                    <div class="btn-set">
