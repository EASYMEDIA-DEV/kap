                        ...
                        <div class="form-group">
                          ...
                          <div class="btn-wrap btn-down-wrap">
                            <c:forEach var="item" items="${rtnRoundDtl.smjList}" varStatus="status">
                              <a class="btn-text-icon download gray" href="/file/download?fileSeq=${item.scrtyEnvrnmtFileSeq}&fileOrd=${item.fileOrd}" download="" title="양식 다운로드"><span>양식 다운로드</span></a>
