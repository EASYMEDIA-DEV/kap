...
<div class="cont-wrap" data-controller="controller/wb/wbc/WBCSecurityCtrl">
    ...
    <div class="sub-top-vis-area basic-page">
        ...
        <div class="img-area">
            <div class="img">
                <img class="only-pc" src="/common/images/img-sub-top-visual-san-com-security.jpg" alt="">
                <img class="only-mobile" src="/common/images/img-sub-top-visual-san-com-security-mobile.jpg" alt="">
            </div>
        </div>
    </div>
                        ...
                        <div class="sec-con-area">
                            <div class="graphic-sec">
                                <div class="box-btn-area">
                                    ...
                                    <div class="btn-wrap">
                                        <a class="btn-solid small white-bg" href="/foundation/cs/qa/index?inqFir=INQ07&inqSec=보안환경구축"><span>신청 문의하기</span></a>
                                    </div>
                                </div>
                ...
                <div class="accepting-fixed-area">
                    <div class="for-position">
                        <button class="open-click-area" type="button">
                            <p class="tit"><span>${rtnRoundDtl.year} ${rtnRoundDtl.episd}차 보안환경구축 사업 접수중</span></p>
                        ...
                        <div class="hide-area">
                            <div class="inner-con">
                                <div class="tit-area">
                                    <p class="f-title1">${rtnRoundDtl.year} ${rtnRoundDtl.episd}차 보안환경구축 사업 접수중</p>
                                </div>
                                <div class="con-area">
                                    ...
                                    <c:if test="${not empty rtnRoundDtl.smjList}">
                                        <div class="btn-set">
                                            <c:forEach var="item" items="${rtnRoundDtl.smjList}" varStatus="status">
                                                <a class="btn-solid small gray-bg has-icon download fileDown" href="javascript:" data-url="/file/download?fileSeq=${item.scrtyEnvrnmtFileSeq}&fileOrd=${item.fileOrd}" download="" title="양식 다운로드"><span>양식 다운로드</span></a>
                                            </c:forEach>
                                        </div>
                                    </c:if>
                                    <div class="btn-set">
