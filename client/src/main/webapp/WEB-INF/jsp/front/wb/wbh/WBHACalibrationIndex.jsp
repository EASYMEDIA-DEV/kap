...
<div class="cont-wrap" data-controller="controller/wb/wbh/WBHACalibrationCtrl">
    <!--
                        ...
                        <div class="sec-con-area">
                            <div class="graphic-sec">
                                <div class="box-btn-area">
                                    ...
                                    <div class="btn-wrap">
                                        <a class="btn-solid small white-bg" href="/foundation/cs/qa/index?inqFir=INQ07&inqSec=검교정"><span>신청 문의하기</span></a>
                                    </div>
                                </div>
            ...
            <div class="accepting-fixed-area">
                <div class="for-position">
                    <button class="open-click-area" type="button">
                        <p class="tit">${sysYear} 검교정 사업 접수중 (상시접수중)</p>
