...
<div class="cont-wrap" data-controller="controller/wb/wbh/WBHACalibrationCtrl controller/wb/wbh/WBHAWriteCtrl">
                        ...
                        <div class="for-motion">
                            ...
                            <div class="sec-con-area">
                                <div class="data-enter-form">
                                    <div class="row">
                                        <div class="th">
                                            <p class="title f-head">대상장비<span class="essential-mark color-sky">*</span></p>
                                        </div>
                                        <div class="td">
                                            <div class="data-line-w">
                                                <div class="addEquiment">
                                                    <div class="data-inner-line equiment">
                                                        <div class="form-group">
                                                            <div class="form-input w-longer">
                                                                <input type="text" class="tchlgNm" name="euipmentList[0].tchlgNm" placeholder="장비명 입력">
                                                            </div>
                                                            <div class="amount-div">
                                                                ...
                                                                <div class="form-input">
                                                                    <input type="text" class="tchlgCnt numberChk" name="euipmentList[0].tchlgCnt" value="1">
                                                                </div>
                                                    ...
                                                    <div class="add-data-result">
                                                        ...
                                                        <div class="amount-result-w">
                                                            <div class="amount-result">
                                                                <div class="amount-num-div f-body1">대상장비<span class="f-title2 equimentCnt">1</span>종</div>
                                                            </div>
                                                            <div class="amount-result">
                                                                <div class="amount-num-div f-body1">총 수량<span class="f-title2 totalCnt">1</span>개</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="data-line">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="file-btn-area">
                                                            ...
                                                            <input type="file" class="searchFile" name="atchFile" id="searchFile">
                                                            <label class="btn-solid gray-bg" for="searchFile">파일 찾기</label>
                                                        </div>
                                                        <div class="btn-wrap btn-down-wrap">
                                                            <a class="btn-text-icon download fileDown" href="javascript:" data-url="/file/download?fileSeq=${rtnData.fileSeq}&fileOrd=${rtnData.fileOrd}" download=""><span>양식 다운로드</span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="data-line">
                                                    <p class="data-title f-body1">대상장비 리스트</p>
                                                    <div class="form-group">
                                                        <div class="file-list-area"><!-- 파일 첨부되면 attached 클래스 추가 -->
                                                            <p class="empty-txt">선택된 파일 없음</p>
                                                        </div>
                                                        <div class="file-btn-area">
                                                            ...
                                                            <input type="file" class="searchFile" name="atchFile1" id="searchFile1">
