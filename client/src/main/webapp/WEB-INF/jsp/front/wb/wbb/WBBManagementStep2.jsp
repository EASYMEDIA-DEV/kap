                    ...
                    <div class="data-line-w">
                      <div class="data-line">
                        <div class="noti-txt-w">
                          ...
                          <p class="bullet-noti-txt f-caption2">※ 첨부 가능 확장자(jpg,jpeg,png,pdf,ppt,pptx,xlsx,doc,docx,hwp,hwpx,txt,zip) / 용량(최대100MB) / 최대개수(1개)</p>
                        </div>
                      </div>
                        ...
                        <div class="data-line">
                          ...
                          <div class="form-group">
                            ...
                            <div class="btn-wrap btn-down-wrap">
                              <a class="btn-text-icon download fileDown" href="javascript:" data-url="/file/download?fileSeq=${item.fileSeq}&fileOrd=0" download=""><span>양식 다운로드</span></a>
                            </div>
                          </div>
                        </div>
                      </c:forEach>
