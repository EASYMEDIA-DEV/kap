...
public class MPBCoexistenceController {
    ...
    public String getCoexistenceList(MPBBsnSearchDTO mpbBnsSearchDTO, ModelMap modelMap, HttpServletRequest request) throws Exception {
    ...
    public String addRoundMore(MPBBsnSearchDTO mpbBnsSearchDTO, ModelMap modelMap) throws Exception {
        try {
    ...
    public String getCoexistenceView(MPBBsnSearchDTO mpbBnsSearchDTO, ModelMap modelMap, HttpServletRequest request) throws Exception {
    ...
    public String update(MPBBsnMstDTO mpbBnsMstDTO, MultipartHttpServletRequest multiRequest, ModelMap modelMap, HttpServletRequest request) throws Exception
    {
        try
        {
            int respCnt = 0;
